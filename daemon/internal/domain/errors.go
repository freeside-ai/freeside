...
var (
	...
	ErrInvalidInitiatorMode             = errors.New("invalid initiator mode")
	...
	ErrInvalidReviewDisposition         = errors.New("invalid review disposition")
	ErrInvalidReviewFailureClass        = errors.New("invalid review failure class")
	ErrInvalidReviewCompletionEvidence  = errors.New("invalid review completion evidence digest")
	...
	ErrInvalidTaskEventKind             = errors.New("invalid task event kind")
	...
	ErrInvalidSpecificationSourceKind   = errors.New("invalid specification source kind")
	...
	ErrTaskEventDetailMismatch      = errors.New("task event detail fields do not match the kind's contract")
	...
	ErrClosableSourceInconsistent         = errors.New("closable source fact is internally inconsistent")
	ErrClosableSourceAbsent               = errors.New("work unit has no closable source for a closure proposal")
	...
	ErrRequirementSetEmpty           = errors.New("readiness evaluation requires the nonempty current requirement set")
	ErrEvaluationTargetMismatch      = errors.New("check proof is not bound to the evaluation target")
	ErrRequirementSetUntrusted       = errors.New("requirement set is not registered in the daemon's trusted requirement registry")
	...
	ErrCodexReenrollmentBindingOutsideItem = errors.New("codex re-enrollment recovery binding is a system_health semantic")
	ErrCodexReenrollmentBindingMissing     = errors.New("codex re-enrollment recovery item lacks its verified binding")
	ErrCodexReenrollmentBindingMismatch    = errors.New("codex re-enrollment recovery binding disagrees with its verified operation")
	ErrCodexReenrollmentMarkerMismatch     = errors.New("codex re-enrollment recovery disagrees with its revoked-identity marker")
