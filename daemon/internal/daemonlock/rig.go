...
var (
	...
	rigContainerNamePattern    = regexp.MustCompile(`^(freeside-handoff-c[0-9a-f]{31}-(seeder|observer|ins-seed|ins-check|prompt-seed|prompt-check|cfg-seed|cfg-check|projects-check|sess-check|writer-check|cred-pre|cred-post|agent|exporter)|freeside-handoff-conf-[0-9a-f]{16}-(seeder|observer|ins-seed|ins-check|agent|exporter)|freeside-handoff-review-[0-9a-f]{24}-(seeder|observer)|freeside-review-review-[0-9a-f]{24}-(ws-obs|workspace-observer|agents-init|agents-obs|agents-observer|snap-init|snap-obs|codex)|freeside-ward-conf-[0-9a-f]{16}-prejob|freeside-ward-conf-conf-[0-9a-f]{16}-(liveness|seed|audit|excl-writer|excl-second|net-live|net|inx-live|inx)|freeside-preflight-credential-[0-9a-f]{12})$`)
	rigVolumeNamePattern       = regexp.MustCompile(`^(freeside-handoff-c[0-9a-f]{31}-(ws|ins|prompt|cfg|projects|session-env)|freeside-handoff-conf-[0-9a-f]{16}-(ws|ins)|freeside-handoff-review-[0-9a-f]{24}-ws|freeside-review-review-[0-9a-f]{24}-(agents|snap)|freeside-ward-conf-conf-[0-9a-f]{16}-(cred|liveness-ws|excl-ws|net-live-ws|inx-ws))$`)
